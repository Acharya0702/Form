...
<body>
	<div class="container">
		<h1 class="text-success text-center">Login_Form</h1><br>
		<div class="col-md-8 m-auto d-block">
			<form action="registration2.php" onsubmit = "return validation()" class = "bg-light" method="post">
				...
				<button type="submit" name="submit" value="subimt" class="btn btn-success">Login</button>
			</form>
		</div>
	</div>
